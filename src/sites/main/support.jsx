    ...
    return (
        <>
            <div className="container mx-auto">
                <h1 className="font-['courgette'] text-6xl">Wsparcie</h1>
               <p className=" text-xl  mt-8 text-left"><span className="font-bold font-['courgette']">Patronite - </span>
                ...
                <p className=" text-xl  mt-8 text-left"><span className="font-bold font-['courgette']">Oryginalne gry - </span>
                    Jeśli masz w swojej kolekcji stare gry przygodowe, których nie ma już w oficjalnej dystrybucji, i chciałbyś się ich pozbyć, chętnie odkupię je po cenie niekolekcjonerskiej, tj. porównywalnej do cen podobnych gier z oficjalnej dystrubcji elektronicznej. Jeśli myślisz w tym momencie o kwocie pięciuset złotych, utnij jedno zero :) Nagrywam wyłącznie materiały z oryginalnych gier i chętnie powiększę swój stan posiadania, aby na mój kanał mogły trafić także mniej znane bądź zapomniane perełki sprzed lat. Poniżej prezentuję listę gier, które chętnie odkupię.
                </p>
